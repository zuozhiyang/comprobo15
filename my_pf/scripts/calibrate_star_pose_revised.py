...
#
#     def run(self):
#         client = dynamic_reconfigure.client.Client("star_center_positioning_node", timeout=30,
...
#
#                 print "rosrun my_pf star_center_position_revised.py _pose_correction:=" + str(
#                     R) + " _phase_offset:=" + str(phase_offset)
