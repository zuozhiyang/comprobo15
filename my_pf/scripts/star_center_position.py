...
#         xy_yaw = (translation_rotated[0] + self.position[0], translation_rotated[1] + self.position[1],
...
#                                                   marker.pose.pose.orientation.z,
#                                                   marker.pose.pose.orientation.w))
#             angle_diffs = TransformHelpers.angle_diff(euler_angles[0], pi), TransformHelpers.angle_diff(euler_angles[1],
#                                                                                                         0)
...
#                 try:
#                     offset, quaternion = self.tf_listener.lookupTransform("/base_link", "/base_laser_link",
#                                                                           rospy.Time(0))
#                 except Exception as inst:
#                     print "Error", inst
#                     return
...
#                         header=Header(stamp=rospy.Time(), frame_id="base_link"))
#         try:
...
#             return
#         self.tf_broadcaster.sendTransform(self.translation, self.rotation, rospy.get_rostime(), self.odom_frame_name,
#                                           "STAR")
#
#     def run(self):
#         r = rospy.Rate(10)
